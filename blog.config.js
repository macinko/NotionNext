...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一名精通电脑技术的财务人员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kj.macin.ac.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/alpinebaba', // 你的twitter个人主页
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '马斯克', // 站点描述，被notion中的页面描述覆盖
