...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个精通计算机技术的财务人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kj.macinko.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Accounting, 会计', // 网站关键词 英文逗号隔开
